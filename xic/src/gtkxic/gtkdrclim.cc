...
sDL::update()
{
    ...
    if (DRC()->errorLevel() == DRCone_err) {
        ...
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b1), true);
        GRX->SetStatus(dl_b2, false);
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b2), false);
        GRX->SetStatus(dl_b3, false);
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b3), false);
    }
    else if (DRC()->errorLevel() == DRCone_type) {
        GRX->SetStatus(dl_b1, false);
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b1), false);
        GRX->SetStatus(dl_b2, true);
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b2), true);
        GRX->SetStatus(dl_b3, false);
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b3), false);
    }
    else {
        ...
        gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(dl_b3), true);
    }
}
